...
rho_shell, cshell, kshell = 2681.0, 959.11, 93
...
Lr3, Lz3, Nr3, Nz3 = 10e-6, 10e-6, 20, 20
...
# thermal
coord_index4_top  = gg.get_coarse_neighbor_points(R4mat_th, Z4mat_th, ghost_inds_top4_th, dr3, dz3, r3_all_th, z3_all_th, 0, ghost_nodes_z, ghost_nodes_x)
...
coord_index2_right  = gg.get_coarse_neighbor_points(R2mat_th, Z2mat_th, ghost_inds_right2_th, dr3, dz3, r3_all_th, z3_all_th, 1, ghost_nodes_z, ghost_nodes_x)
coord_index3_left   = gg.get_fine_neighbor_points(R3mat_th, Z3mat_th, ghost_inds_left3_th, dr3, dz3, R2mat_th, Z2mat_th, r2_all_th, z2_all_th, 1, ghost_nodes_z, ghost_nodes_x)
coord_index3_bot    = gg.get_fine_neighbor_points(R3mat_th, Z3mat_th, ghost_inds_bot3_th, dr3, dz3, R4mat_th, Z4mat_th, r4_all_th, z4_all_th, 0, ghost_nodes_z, ghost_nodes_x)
...
# mechanical
coord_index4_top_m    = gg.get_coarse_neighbor_points(R4mat_m, Z4mat_m, ghost_inds_top4_m, dr3, dz3, r3_all_m, z3_all_m, 0, ghost_nodes_z, ghost_nodes_x)
...
coord_index2_right_m  = gg.get_coarse_neighbor_points(R2mat_m, Z2mat_m, ghost_inds_right2_m, dr3, dz3, r3_all_m, z3_all_m, 1, ghost_nodes_z, ghost_nodes_x)
coord_index3_left_m   = gg.get_fine_neighbor_points(R3mat_m, Z3mat_m, ghost_inds_left3_m, dr3, dz3, R2mat_m, Z2mat_m, r2_all_m, z2_all_m, 1, ghost_nodes_z, ghost_nodes_x)
coord_index3_bot_m    = gg.get_fine_neighbor_points(R3mat_m, Z3mat_m, ghost_inds_bot3_m, dr3, dz3, R4mat_m, Z4mat_m, r4_all_m, z4_all_m, 0, ghost_nodes_z, ghost_nodes_x)
...
T4 = gg.interpolate_temperature_for_coarse(T4, T3, coord_index4_top)   # 细网格 → 粗网格
T4 = gg.interpolate_temperature_for_fine(T4, T1, coord_index4_left)  # 细网格 → 粗网格
...
T2 = gg.interpolate_temperature_for_fine(T2, T1, coord_index2_bot)    # 修正
T2 = gg.interpolate_temperature_for_coarse(T2, T3, coord_index2_right)
...
T3 = gg.interpolate_temperature_for_fine(T3, T2, coord_index3_left)     # 修正
T3 = gg.interpolate_temperature_for_fine(T3, T4, coord_index3_bot)
...
for step1 in range(nsteps_th):
    ...
    T4 = gg.interpolate_temperature_for_coarse(T4, T3, coord_index4_top)  # 修正：3是细，4是粗
    T4 = gg.interpolate_temperature_for_fine(T4, T1, coord_index4_left)  # 修正：1是细，4是粗
    T4 = bc_funcs.apply_bc_zero_flux(T4, ghost_inds_bot4_th, interior_inds_bot4_th, axis=0)
    T4 = bc_funcs.apply_bc_dirichlet_mirror(T4, ghost_inds_right4_th, interior_inds_right4_th, T_increment, axis=1,
                                            z_mask=None, r_mask=None)
    # Region 2

    T2 = gg.interpolate_temperature_for_fine(T2, T1, coord_index2_bot)  # 修正：1是细，2是粗
    T2 = gg.interpolate_temperature_for_coarse(T2, T3, coord_index2_right)  # 修正：3是细，2是粗
    T2 = bc_funcs.apply_bc_zero_flux(T2, ghost_inds_left2_th, interior_inds_left2_th, axis=1)
    T2 = bc_funcs.apply_bc_dirichlet_mirror(T2, ghost_inds_top2_th, interior_inds_top2_th, T_increment, axis=0,
                                            z_mask=None, r_mask=None)
    # Region 3

    T3 = gg.interpolate_temperature_for_fine(T3, T2, coord_index3_left)  # 修正：2是粗，3是细
    T3 = gg.interpolate_temperature_for_fine(T3, T4, coord_index3_bot)  # 修正：4是粗，3是细
    T3 = bc_funcs.apply_bc_dirichlet_mirror(T3, ghost_inds_right3_th, interior_inds_right3_th, T_increment, axis=1,
                                            z_mask=None, r_mask=None)
    T3 = bc_funcs.apply_bc_dirichlet_mirror(T3, ghost_inds_top3_th, interior_inds_top3_th, T_increment, axis=0,
                                            z_mask=None, r_mask=None)
    # Region 1
    T1 = gg.interpolate_temperature_for_coarse(T1, T2, coord_index1_top)
    T1 = gg.interpolate_temperature_for_coarse(T1, T4, coord_index1_right)
    ...
    if step1 == 0:
        ...
        Ur4 = gg.interpolate_temperature_for_coarse(Ur4, Ur3, coord_index4_top_m)  # fine → coarse
        Uz4 = gg.interpolate_temperature_for_coarse(Uz4, Uz3, coord_index4_top_m)
